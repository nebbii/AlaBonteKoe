...
<ul id="slider">
        <li>
            <a href="restaurant_home.php">
                <img src="images/nr3.jpg" width="100%" height="100%" draggable="false"/>
            </a>
        ...
        <li>
            <a href="uitgaan_home.php">
                <img src="images/nr2.jpg"  width="100%" height="100%"  draggable="false"/>
            </a>
        ...
        <li>
            <a href="bioscoop_home.php">
                <img src="images/nr1.jpg"  width="100%" height="100%" draggable="false" />
            </a>
